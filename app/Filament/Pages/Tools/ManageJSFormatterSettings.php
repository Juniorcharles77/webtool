...
class ManageJSFormatterSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Js Formatter Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = JSFormatterSettings::class;

...
class ManagePasswordStrengthTestSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Password Strength Test Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = PasswordStrengthTestSettings::class;

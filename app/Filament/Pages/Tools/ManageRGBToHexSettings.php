...
class ManageRGBToHexSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Rgb To Hex Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = RGBToHexSettings::class;

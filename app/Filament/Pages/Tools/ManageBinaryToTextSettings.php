...
class ManageBinaryToTextSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Binary To Text Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = BinaryToTextSettings::class;

...
class ManageWordCountSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Word Count Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = WordCountSettings::class;

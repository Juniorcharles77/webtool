...
class ManageHTMLEntityDecodeSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Html Entity Decode Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = HTMLEntityDecodeSettings::class;

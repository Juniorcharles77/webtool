...
class ManageJSMinifierSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Js Minifier Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = JSMinifierSettings::class;

...
class ManagePrivacyPolicyGeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Privacy Policy Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = PrivacyPolicyGeneratorSettings::class;

...
class ManageTimestampConverterSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Timestamp Converter Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = TimestampConverterSettings::class;

...
class ManageCSVToJSONSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Csv To Json Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = CSVToJSONSettings::class;

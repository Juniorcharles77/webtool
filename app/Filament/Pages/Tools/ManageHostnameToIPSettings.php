...
class ManageHostnameToIPSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Hostname To Ip Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = HostnameToIPSettings::class;

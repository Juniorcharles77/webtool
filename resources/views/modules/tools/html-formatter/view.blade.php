<div x-data="window.bitflanFormattersComponent()">
    <div class="form-group">
        <label class="custom-label">{{ trans('webtools/tools/html-formatter.label') }}</label>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="form-group">
    ...
    <button x-on:click="formatHtml()" class="btn custom--btn button__lg">{{ trans('webtools/tools/html-formatter.submit') }}</button>
</div>
...
class ManageIPToHostnameSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Ip To Hostname Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = IPToHostnameSettings::class;

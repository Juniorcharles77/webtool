...
class ManageHTMLMinifierSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Html Minifier Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = HTMLMinifierSettings::class;

...
class ManageJSONToCSVSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Json To Csv Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = JSONToCSVSettings::class;

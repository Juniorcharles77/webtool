...
class ManageWhatsMyIpSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Whats My Ip Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = WhatsMyIpSettings::class;

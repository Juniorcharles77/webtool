...
class ManageDuplicateLinesRemoverSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Duplicate Lines Remover Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = DuplicateLinesRemoverSettings::class;

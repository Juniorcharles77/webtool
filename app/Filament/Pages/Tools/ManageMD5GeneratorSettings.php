...
class ManageMD5GeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Md5 Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = MD5GeneratorSettings::class;

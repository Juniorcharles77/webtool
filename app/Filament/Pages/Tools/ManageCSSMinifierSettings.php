...
class ManageCSSMinifierSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Css Minifier Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = CSSMinifierSettings::class;

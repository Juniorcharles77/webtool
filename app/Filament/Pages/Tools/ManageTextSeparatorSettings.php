...
class ManageTextSeparatorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Text Separator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = TextSeparatorSettings::class;

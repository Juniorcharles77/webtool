...
class ManageTermsOfServiceGeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Terms Of Service Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = TermsOfServiceGeneratorSettings::class;

...
class ManageRobotstxtGeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Robotstxt Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = RobotstxtGeneratorSettings::class;

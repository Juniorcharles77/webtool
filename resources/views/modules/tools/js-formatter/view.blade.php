<div x-data="window.bitflanFormattersComponent('javascript')">
    <div class="form-group">
        <label class="custom-label">{{ trans('webtools/tools/js-formatter.label') }}</label>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="form-group">
    ...
    <button x-on:click="formatJs()" class="btn custom--btn button__lg">{{ trans('webtools/tools/js-formatter.submit') }}</button>
</div>
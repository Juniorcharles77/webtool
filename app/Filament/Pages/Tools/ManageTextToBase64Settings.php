...
class ManageTextToBase64Settings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Text To Base64 Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = TextToBase64Settings::class;

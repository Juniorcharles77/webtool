...
class ManageEmailValidatorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Email Validator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = EmailValidatorSettings::class;

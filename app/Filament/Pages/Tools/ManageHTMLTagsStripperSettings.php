...
class ManageHTMLTagsStripperSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Html Tags Stripper Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = HTMLTagsStripperSettings::class;

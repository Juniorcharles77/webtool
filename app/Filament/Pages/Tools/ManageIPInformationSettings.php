...
class ManageIPInformationSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Ip Information Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = IPInformationSettings::class;

...
class ManageUUIDv4GeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Uuidv4 Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = UUIDv4GeneratorSettings::class;

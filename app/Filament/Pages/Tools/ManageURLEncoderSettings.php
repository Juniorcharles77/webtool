...
class ManageURLEncoderSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Url Encoder Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = URLEncoderSettings::class;

...
class ManageQRGeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Qr Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = QRGeneratorSettings::class;

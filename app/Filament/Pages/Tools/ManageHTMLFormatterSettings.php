...
class ManageHTMLFormatterSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Html Formatter Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = HTMLFormatterSettings::class;

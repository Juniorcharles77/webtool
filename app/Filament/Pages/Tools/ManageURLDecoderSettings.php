...
class ManageURLDecoderSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Url Decoder Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = URLDecoderSettings::class;

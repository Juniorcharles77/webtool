...
class ManageQRCodeReaderSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Qr Code Reader Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = QRCodeReaderSettings::class;

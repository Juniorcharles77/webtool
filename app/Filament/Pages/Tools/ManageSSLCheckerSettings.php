...
class ManageSSLCheckerSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Ssl Checker Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = SSLCheckerSettings::class;

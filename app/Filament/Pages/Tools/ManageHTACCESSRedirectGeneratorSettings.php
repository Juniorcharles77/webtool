...
class ManageHTACCESSRedirectGeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Htaccess Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = HTACCESSRedirectGeneratorSettings::class;

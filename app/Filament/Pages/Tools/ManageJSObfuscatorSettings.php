...
class ManageJSObfuscatorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Js Obfuscator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = JSObfuscatorSettings::class;

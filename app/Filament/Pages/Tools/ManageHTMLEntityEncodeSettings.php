...
class ManageHTMLEntityEncodeSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Html Entity Encode Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = HTMLEntityEncodeSettings::class;

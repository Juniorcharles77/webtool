...
class ManageLoremIpsumGeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Lorem Ipsum Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = LoremIpsumGeneratorSettings::class;

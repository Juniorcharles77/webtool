...
class ManagePasswordGeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Password Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = PasswordGeneratorSettings::class;

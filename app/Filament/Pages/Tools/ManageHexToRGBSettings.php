...
class ManageHexToRGBSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Hex To Rgb Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = HexToRGBSettings::class;

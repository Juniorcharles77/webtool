...
class ManageEmailExtractorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Email Extractor Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = EmailExtractorSettings::class;

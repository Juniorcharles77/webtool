...
class ManageURLUnshortenerSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Url Unshortener Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = URLUnshortenerSettings::class;

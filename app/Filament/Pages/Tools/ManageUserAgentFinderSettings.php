...
class ManageUserAgentFinderSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'User Agent Finder Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = UserAgentFinderSettings::class;

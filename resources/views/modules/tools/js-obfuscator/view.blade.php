<div x-data="window.bitflanFormattersComponent('javascript')">
    <div class="form-group">
        <label class="custom-label">{{ trans('webtools/tools/js-obfuscator.label') }}</label>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="form-group">
    ...
    <button x-on:click="obfuscateJs()" class="btn custom--btn button__lg">{{ trans('webtools/tools/js-obfuscator.submit') }}</button>
</div>
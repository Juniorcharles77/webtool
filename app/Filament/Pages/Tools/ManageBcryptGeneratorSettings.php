...
class ManageBcryptGeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Bcrypt Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = BcryptGeneratorSettings::class;

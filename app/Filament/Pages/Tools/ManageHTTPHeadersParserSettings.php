...
class ManageHTTPHeadersParserSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Http Headers Parser Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = HTTPHeadersParserSettings::class;

...
class ManageImageToBase64Settings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Image To Base64 Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = ImageToBase64Settings::class;

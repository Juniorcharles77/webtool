...
class ManageTextToBinarySettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Text To Binary Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = TextToBinarySettings::class;

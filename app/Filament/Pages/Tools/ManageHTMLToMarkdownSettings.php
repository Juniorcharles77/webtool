...
class ManageHTMLToMarkdownSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Html To Markdown Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = HTMLToMarkdownSettings::class;

...
class ManageHTTPStatusCodeCheckerSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Http Status Code Checker Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = HTTPStatusCodeCheckerSettings::class;

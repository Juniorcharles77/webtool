...
class ManageYouTubeThumbnailDownloaderSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Youtube Thumbnail Downloader Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = YouTubeThumbnailDownloaderSettings::class;

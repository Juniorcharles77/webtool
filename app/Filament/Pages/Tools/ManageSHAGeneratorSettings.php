...
class ManageSHAGeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Sha Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = SHAGeneratorSettings::class;

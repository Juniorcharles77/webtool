...
class ManageWebsiteStatusCheckerSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Website Status Checker Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = WebsiteStatusCheckerSettings::class;
